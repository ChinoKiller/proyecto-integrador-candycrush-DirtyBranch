all:
	...
	g++ -no-pie -o ./bin/jugar ./build/Controlador.o ./src/main.cpp ./build/GameBoard.o ./build/MatrixFunc.o ./build/Level.o -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio
