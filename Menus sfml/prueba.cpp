...
int main() {
    ...
    enum Menu { MAIN_MENU, LEVEL_MENU, INSTRUCTIONS_MENU, SETTINGS_MENU };
    Menu currentMenu = MAIN_MENU;
        ...
        while(currentMenu == MAIN_MENU){
            ...
            if (event.type == sf::Event::KeyPressed) {
                if (currentMenu == MAIN_MENU) {
                    ...
                    // Agregar manejo de eventos para otros menús aquí
                }
            }
        } 
         while(currentMenu == SETTINGS_MENU){window.close();return 0;}
         while(currentMenu == INSTRUCTIONS_MENU){window.close();return 0;}
         while(currentMenu == LEVEL_MENU){window.close();return 0;}
